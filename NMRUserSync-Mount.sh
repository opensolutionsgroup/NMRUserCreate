...
read -r -p "Enter the new users name: " username
username=${username,,}
...
echo "Syncing Mount Points"
echo "# Adding [ $username ] NMRUserSync-Mount on $(date '+%A, %d %B %Y, %T')" >> fstab.add

if [ -d "/var/www/html/Raw-Files/300B/${username[@]^}/nmr" ] && [ ! -d /home/${username,}/NMRData/300B ]; then
	mkdir NMRData/300B
...
elif [ -d "/var/www/html/Raw-Files/300B/${username,}/nmr" ] && [ ! -d /home/${username,}/NMRData/300B ]; then
	mkdir NMRData/300B
	mount --bind /var/www/html/Raw-Files/300B/${username,}/nmr /home/${username,}/NMRData/300B
	echo "/var/www/html/Raw-Files/300B/${username,}/nmr /home/${username,}/NMRData/300B none bind 0 0" >> fstab.add
fi

if [ -d "/var/www/html/Raw-Files/300BIconNMR/${username[@]^}/nmr" ] && [ ! -d /home/${username,}/NMRData/300BIconNMR ]; then
...
elif [ -d "/var/www/html/Raw-Files/300BIconNMR/${username,}/nmr" ] && [ ! -d /home/${username,}/NMRData/300BIconNMR ]; then
	mkdir NMRData/300BIconNMR
	mount --bind /var/www/html/Raw-Files/300BIconNMR/${username,}/nmr /home/${username,}/NMRData/300BIconNMR
	echo "/var/www/html/Raw-Files/300BIconNMR/${username,}/nmr /home/${username,}/NMRData/300BIconNMR none bind 0 0" >> fstab.add
fi

if [ -d "/var/www/html/Raw-Files/500/${username[@]^}/nmr" ] && [ ! -d /home/${username,}/NMRData/500 ]; then
	mkdir NMRData/500
...
elif [ -d "/var/www/html/Raw-Files/500/${username,}/nmr" ]  && [ ! -d /home/${username,}/NMRData/500 ]; then
	mkdir NMRData/500
	mount --bind /var/www/html/Raw-Files/500/${username,}/nmr /home/${username,}/NMRData/500
	echo "/var/www/html/Raw-Files/500/${username,}/nmr /home/${username,}/NMRData/500 none bind 0 0" >> fstab.add
fi

if [ -d "/var/www/html/Raw-Files/Ascend300/Data/${username[@]^}" ] && [ ! -d /home/${username,}/NMRData/Ascend300 ]; then
...
elif [ -d "/var/www/html/Raw-Files/Ascend300/Data/${username,}" ] && [ ! -d /home/${username,}/NMRData/Ascend300 ]; then
	mkdir NMRData/Ascend300
	mount --bind /var/www/html/Raw-Files/Ascend300/Data/${username,} /home/${username,}/NMRData/Ascend300
	echo "/var/www/html/Raw-Files/Ascend300/Data/${username,} /home/${username,}/NMRData/Ascend300 none bind 0 0" >> fstab.add
fi

if [ -d "/var/www/html/Raw-Files/NEO600/Data/${username[@]^}" ] && [ ! -d /home/${username,}/NMRData/NEO600 ]; then
...
elif [ -d "/var/www/html/Raw-Files/NEO600/Data/${username,}" ] && [ ! -d /home/${username,}/NMRData/NEO600 ]; then
	mkdir NMRData/NEO600
	mount --bind /var/www/html/Raw-Files/NEO600/Data/${username,} /home/${username,}/NMRData/NEO600
	echo "/var/www/html/Raw-Files/NEO600/Data/${username,} /home/${username,}/NMRData/NEO600 none bind 0 0" >> fstab.add
fi
